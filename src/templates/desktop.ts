...
export class desktop extends Template<TemplateType.DESKTOP>{
    readonly height: number = 233;
    readonly width: number = 760;

    private constructor(thumb: Thumbnail) {
        super(TemplateType.DESKTOP, thumb);
    }

    static generate(thumb: Thumbnail) {
        return new desktop(thumb);
    }
